(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["goodtables"] = factory();
	else
		root["goodtables"] = factory();
})(this, function() {
...
var baseIsNative = __webpack_require__(413),
    getValue = __webpack_require__(445);
...
var Symbol = __webpack_require__(55),
    getRawTag = __webpack_require__(444),
...
var isKeyable = __webpack_require__(457);
...
var mapCacheClear = __webpack_require__(464),
    mapCacheDelete = __webpack_require__(465),
    mapCacheGet = __webpack_require__(466),
    mapCacheHas = __webpack_require__(467),
    mapCacheSet = __webpack_require__(468);
...
var ListCache = __webpack_require__(69),
    stackClear = __webpack_require__(476),
    stackDelete = __webpack_require__(477),
    stackGet = __webpack_require__(478),
    stackHas = __webpack_require__(479),
    stackSet = __webpack_require__(480);
...
var defineProperty = __webpack_require__(440);
...
var size = __webpack_require__(494);
var clone = __webpack_require__(179);
var pickBy = __webpack_require__(492);
var mapKeys = __webpack_require__(490);
var isArray = __webpack_require__(22);
var snakeCase = __webpack_require__(495);
...
var ApiClient = function () {
  ...
  _createClass(ApiClient, [{
    key: 'addReport',
    value: function () {
      var _ref2 = _asyncToGenerator(regeneratorRuntime.mark(function _callee(source) {
        var options = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};

        var checks, errorLimit, tableLimit, rowLimit, inferSchema, inferFields, orderFields, settings, files, fileType, _iteratorNormalCompletion, _didIteratorError, _iteratorError, _iterator, _step, item, _arr, _i, key, name, payload, _iteratorNormalCompletion2, _didIteratorError2, _iteratorError2, _iterator2, _step2, _step2$value, file, job, url, response;
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                // Extract job config
                );checks = pop(options, 'checks');
                errorLimit = pop(options, 'errorLimit');
                tableLimit = pop(options, 'tableLimit');
                rowLimit = pop(options, 'rowLimit');
                inferSchema = pop(options, 'inferSchema');
                inferFields = pop(options, 'inferFields');
                orderFields = pop(options, 'orderFields'

                // Prepare source
                );
                if (!isArray(source)) source = [Object.assign(options, { source: source })];
                ...
                // Prepare settings
                  ...
                  errorLimit: errorLimit, tableLimit: tableLimit, rowLimit: rowLimit,
                  inferSchema: inferSchema, inferFields: inferFields, orderFields: orderFields };

                settings = pickBy(settings, function (value) {
                  return value !== undefined;
                });
                settings = mapKeys(settings, function (value, key) {
                  return snakeCase(key);
                }

                // Extract files
                );files = {};
                fileType =  true ? File : Buffer;
                _iteratorNormalCompletion = true;
                _didIteratorError = false;
                _iteratorError = undefined;
                _context.prev = 18;

                for (_iterator = source[Symbol.iterator](); !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
                  item = _step.value;
                  _arr = ['source', 'schema'];
              ...
              case 34:
                payload = { source: source, settings: settings };
                ...
                payload.append('data', JSON.stringify({ source: source, settings: settings }));
                _iteratorNormalCompletion2 = true;
                _didIteratorError2 = false;
                _iteratorError2 = undefined;
                _context.prev = 41;
                for (_iterator2 = Object.entries(files)[Symbol.iterator](); !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
                  _step2$value = _slicedToArray(_step2.value, 2), name = _step2$value[0], file = _step2$value[1];
              ...
              case 57:
                ...
                job = void 0;
                _context.prev = 58;
                url = this._apiUrl + '/source/' + this._apiSourceId + '/job';
                _context.next = 62;
                return axios.post(url, payload, this._requestConfig);
              ...
              case 66:
                ...
                throw new Error('Can\'t create a job on API. Reason: "' + _context.t2 + '"');
        ...
        }, _callee, this, [[18, 22, 26, 34], [27,, 29, 33], [41, 45, 49, 57], [50,, 52, 56], [58, 66]]);
      }));

      function addReport(_x) {
    ...
    key: 'getReport',
    value: function () {
      var _ref3 = _asyncToGenerator(regeneratorRuntime.mark(function _callee3(apiJobId) {
        var _this = this;
          ...
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                ...
                _context3.prev = 1;
                _context3.next = 4;
                return poll({ seconds: 1, attempts: 10 }, _asyncToGenerator(regeneratorRuntime.mark(function _callee2() {
                  var url, response, job;
                  return regeneratorRuntime.wrap(function _callee2$(_context2) {
                    while (1) {
                      switch (_context2.prev = _context2.next) {
                        case 0:
                          url = _this._apiUrl + '/source/' + _this._apiSourceId + '/job/' + apiJobId;
                          _context2.next = 3;
                          return axios.get(url, _this._requestConfig);
                        ...
                        case 8:
                          return _context2.abrupt('return', job.report);
              ...
              case 7:
                ...
                throw new Error('Can\'t get a report from API. Reason: "' + _context3.t0 + '"');
...
module.exports.pop = function (object, key) {
...
module.exports.poll = function (_ref, action) {
...
var each         = __webpack_require__(23)(0)
  , redefine     = __webpack_require__(13)
  , meta         = __webpack_require__(31)
  , assign       = __webpack_require__(143)
...
var baseMatches = __webpack_require__(416),
    ...
    identity = __webpack_require__(488),
    isArray = __webpack_require__(22),
...
var isPrototype = __webpack_require__(114),
    nativeKeys = __webpack_require__(470);
...
var SetCache = __webpack_require__(394),
    arraySome = __webpack_require__(400),
    cacheHas = __webpack_require__(425);
...
var baseGetAllKeys = __webpack_require__(162),
    getSymbolsIn = __webpack_require__(172),
...
var baseClone = __webpack_require__(405);
...
var baseIsTypedArray = __webpack_require__(414),
    ...
    nodeUtil = __webpack_require__(472);
...
module.exports.validate = function () {
  var _ref = _asyncToGenerator(regeneratorRuntime.mark(function _callee(source) {
    var options = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
    var apiUrl, apiToken, apiSourceId, client, apiJobId, report;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            // Extract api config
            );apiUrl = pop(options, 'apiUrl');
            apiToken = pop(options, 'apiToken');
            apiSourceId = pop(options, 'apiSourceId'

            // Get report from api client
            );
            client = new ApiClient({ apiUrl: apiUrl, apiToken: apiToken, apiSourceId: apiSourceId });
            _context.next = 7;
            return client.addReport(source, options);

          case 7:
            apiJobId = _context.sent;
            _context.next = 10;
...
var spec = __webpack_require__(187
...
var $export   = __webpack_require__(0)
  , isInteger = __webpack_require__(139)
  , abs       = Math.abs;
...
var $export  = __webpack_require__(0)
  , $entries = __webpack_require__(147)(true);
...
var $export        = __webpack_require__(0)
  , ownKeys        = __webpack_require__(148)
  , toIObject      = __webpack_require__(15)
  , gOPD           = __webpack_require__(17)
  , createProperty = __webpack_require__(77);
...
// https://github.com/tc39/proposal-object-values-entries
var $export = __webpack_require__(0)
  , $values = __webpack_require__(147)(false);
...
var global     = __webpack_require__(2)
  , $export    = __webpack_require__(0)
  , invoke     = __webpack_require__(62)
  , partial    = __webpack_require__(214)
...
var hashClear = __webpack_require__(449),
    hashDelete = __webpack_require__(450),
    hashGet = __webpack_require__(451),
    hashHas = __webpack_require__(452),
    hashSet = __webpack_require__(453);
...
var Stack = __webpack_require__(104),
    ...
    copySymbols = __webpack_require__(434),
    copySymbolsIn = __webpack_require__(435),
    getAllKeys = __webpack_require__(169),
    getAllKeysIn = __webpack_require__(170),
    getTag = __webpack_require__(111),
    initCloneArray = __webpack_require__(454),
    initCloneByTag = __webpack_require__(455),
...
var createBaseFor = __webpack_require__(437);
...
var baseFor = __webpack_require__(407),
    keys = __webpack_require__(57);
...
var isObject = __webpack_require__(44),
    ...
    nativeKeysIn = __webpack_require__(471);
...
var baseIsMatch = __webpack_require__(412),
    getMatchData = __webpack_require__(443),
...
var addMapEntry = __webpack_require__(396),
...
var addSetEntry = __webpack_require__(397),
    arrayReduce = __webpack_require__(105),
...
var arrayReduce = __webpack_require__(105),
    deburr = __webpack_require__(485),
    words = __webpack_require__(497);
...
var basePropertyOf = __webpack_require__(420);
...
var cloneArrayBuffer = __webpack_require__(109),
    cloneDataView = __webpack_require__(427),
    cloneMap = __webpack_require__(428),
    cloneRegExp = __webpack_require__(429),
    cloneSet = __webpack_require__(430),
    cloneSymbol = __webpack_require__(431),
    cloneTypedArray = __webpack_require__(432);
...
var baseCreate = __webpack_require__(406),
    getPrototype = __webpack_require__(171),
    isPrototype = __webpack_require__(114);
...
/* WEBPACK VAR INJECTION */(function(module) {var freeGlobal = __webpack_require__(168);
...
var asciiSize = __webpack_require__(401),
    hasUnicode = __webpack_require__(447),
    unicodeSize = __webpack_require__(483);
...
var memoizeCapped = __webpack_require__(469);
...
var deburrLetter = __webpack_require__(439),
    toString = __webpack_require__(120);
...
var baseAssignValue = __webpack_require__(107),
    baseForOwn = __webpack_require__(408),
...
var arrayMap = __webpack_require__(160),
    baseIteratee = __webpack_require__(164),
    basePickBy = __webpack_require__(418),
    getAllKeysIn = __webpack_require__(170);
...
var baseKeys = __webpack_require__(165),
    ...
    stringSize = __webpack_require__(481);
...
var createCompounder = __webpack_require__(438);
...
var asciiWords = __webpack_require__(402),
    hasUnicodeWord = __webpack_require__(448),
    toString = __webpack_require__(120),
    unicodeWords = __webpack_require__(484);
...
//# sourceMappingURL=goodtables.js.map